...
The package `prosail` includes the package `prospect`, so please check the briefl tutorial from [this package](https://jbferet.gitlab.io/prospect/articles/prospect.html) if you need specific information on __PROSPECT__.
