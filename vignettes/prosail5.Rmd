...
spec_sensor <- apply_sensor_characteristics(wvl,prosail::spec_prospect_full_range,srf)
...
# apply sensor characteristics to PROSPECT optical constants
properties_sensor <- prepare_sensor_simulation(prosail::spec_prospect_full_range,spec_soil,spec_atm,srf)
