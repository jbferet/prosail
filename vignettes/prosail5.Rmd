...
spec_atm_sensor <- apply_sensor_characteristics(wvl,SpecATM,srf)
# apply sensor characteristics to soil properties
spec_soil_sensor <- apply_sensor_characteristics(wvl,SpecSOIL,srf)
```
...
spec_sensor <- PropSensor$spec_prospect_sensor
spec_soil_sensor <- PropSensor$spec_soil_sensor
spec_atm_sensor <- PropSensor$spec_atm_sensor
```
...
rsoil <- spec_soil_sensor$Dry_Soil
