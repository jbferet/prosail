...
The function `compute_surf_refl` computes the surface reflectance in the 
...
surf_refl_4SAIL <- compute_surf_refl(rdot = refl_prosail$rdot,
                                     rsot = refl_prosail$rsot,
                                     tts = tts,
                                     spec_atm_sensor = spec_atm)
surf_refl_4SAIL2 <- compute_surf_refl(rdot = refl_prosail2$rdot,
...
SRF_S2 <- get_spectral_response_function(sensor_name = sensor_name, 
                                         srf_path = NULL)
```
...
surf_refl_4SAIL_S2 <- apply_sensor_characteristics(wvl = wvl,
                                                   srf = SRF_S2,
                                                   input_refl_table = surf_refl_4SAIL)
```
