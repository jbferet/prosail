...
Make sure you follow the procedure described in the `preprocS2` installation doc 
to save credentials for CDSE
...
S2BandSel <- list('lai' = c('B3','B4','B8'), 'fCover' = c('B3','B4','B8'), 
                  'fAPAR' = c('B3','B4','B8'), 'CHL' = c('B3','B4','B5','B6','B7','B8'), 
                  'EWT' = c('B8A','B11','B12'), 'LMA' = c('B8A','B11','B12'))
Bands2Select <- list()
for (parm in Parms2Estimate)
  Bands2Select[[parm]] <- match(S2BandSel[[parm]], SRF$Spectral_Bands)
