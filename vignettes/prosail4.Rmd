...
list_files <- get_s2_raster(bbox = aoi_bbox, datetime = datetime, 
                            output_dir = output_dir_s2, 
                            path_S2tilinggrid = path_S2tilinggrid, 
                            siteName = 'Barrax', overwrite = FALSE, 
                            geomAcq = TRUE,  authentication = authentication)
...
speed up the application of the inversion on large rasters if needed. 
...
# S2 imagery is provided with refl defined as integer between 0 and 10000
