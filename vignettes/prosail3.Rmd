...
The BRF LUT is produced from `input_prosail` with the function `generate_lut_brf`.
This function is expecting the variables `spec_prospect`, `spec_soil` and `spec_atm` 
