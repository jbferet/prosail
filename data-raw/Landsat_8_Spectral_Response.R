...
Landsat_8 <- list("Spectral_Response"=SensorRadiometry, "Spectral_Bands"=Spectral_Bands,'OriginalBands'=OriginalBands)

## code to prepare `Sentinel_2_Spectral_Response` dataset goes here
usethis::use_data(Landsat_8,compress = 'xz',overwrite = TRUE)
save(Landsat_8,file =  file.path('data',paste(SensorName,'.RData',sep = '')))
